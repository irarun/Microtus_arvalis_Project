...
raw_lines <- readLines("onlyMicrotus_samplesV426.txt", encoding = "latin1")
clean_lines <- iconv(raw_lines, from = "latin1", to = "UTF-8", sub = "")

# Save cleaned file
writeLines(clean_lines, "onlyMicrotus_samplesV426.txt")

rawTable <- read_tsv("onlyMicrotus_samplesV426.txt")
  #col_types = cols(
    #Add = col_character(),
